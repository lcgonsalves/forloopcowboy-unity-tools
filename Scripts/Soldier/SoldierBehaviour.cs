...
using forloopcowboy_unity_tools.Scripts.SquadUnit;
...
// Exposes public methods to control the behavior of a soldier
    public class SoldierBehaviour : MonoBehaviour
    {
        ...
        [Core.ReadOnly, Tooltip("Which transform will parent the gun.")]
        public Transform rightHandReference;

        [Core.ReadOnly, Tooltip("Which transform will be used to cast line-of-sight rays from.")]
        public Transform headReference;

        [Core.ReadOnly, Tooltip("Which transform will be used as a target")]
        ...
        [SerializeField, Core.ReadOnly] [CanBeNull] private HealthComponent _target;
        ...
        private void InitializeWeapon()
        {
            ...
            if (weapon && !weaponRef)
            {
                ...
                weaponGrabHandle = Weapon.Weapon.GrabPointB(weaponRef);
        ...
        [Core.ReadOnly, SerializeField] private Collider[] detected;
