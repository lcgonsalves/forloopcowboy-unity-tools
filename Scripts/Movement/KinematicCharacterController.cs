...
namespace forloopcowboy_unity_tools.Scripts.Movement
{
    /// <summary>
    /// Outsourced from https://assetstore.unity.com/packages/tools/physics/kinematic-character-controller-99131
    /// All rights to the original code belongs to them.
    ...
    public class KinematicCharacterController : NetworkBehaviour, ICharacterController
    {
        ...
        public BonusOrientationMethod CurrentBonusOrientationMethod;
        public float CurrentBonusOrientationSharpness;
                ...
                case CharacterState.Default:
                    {
                        ...
                        if (CurrentBonusOrientationMethod == BonusOrientationMethod.TowardsGravity)
                        {
                            ...
                            Vector3 smoothedGravityDir = Vector3.Slerp(currentUp, -Gravity.normalized, 1 - Mathf.Exp(-CurrentBonusOrientationSharpness * deltaTime));
                        ...
                        else if (CurrentBonusOrientationMethod == BonusOrientationMethod.TowardsGroundSlopeAndGravity)
                        {
                            if (Motor.GroundingStatus.IsStableOnGround)
                            {
                                ...
                                Vector3 smoothedGroundNormal = Vector3.Slerp(Motor.CharacterUp, Motor.GroundingStatus.GroundNormal, 1 - Mathf.Exp(-CurrentBonusOrientationSharpness * deltaTime));
                        ...
                        {
                            Vector3 smoothedGravityDir = Vector3.Slerp(currentUp, Vector3.up, 1 - Mathf.Exp(-CurrentBonusOrientationSharpness * deltaTime));
                            currentRotation = Quaternion.FromToRotation(currentUp, smoothedGravityDir) * currentRotation;
                        }
                        break;
                    }
